...
# 601 "C:/msys64/mingw64/include/stdio.h" 3
  int fseeko64(FILE* stream, _off64_t offset, int whence);
  int fseeko(FILE* stream, _off_t offset, int whence);

  _off_t ftello(FILE * stream);
  _off64_t ftello64(FILE * stream);
# 622 "C:/msys64/mingw64/include/stdio.h" 3
...
# 905 "C:/msys64/mingw64/include/stdio.h" 3
  ...
  ;
# 998 "C:/msys64/mingw64/include/stdio.h" 3
                                                     __attribute__ ((__nonnull__ (2)))
...
# 1058 "C:/msys64/mingw64/include/stdio.h" 3
static __attribute__ ((__unused__)) __inline__ __attribute__((__cdecl__))
                                                      __attribute__ ((__nonnull__ (3)))
...
# 1086 "C:/msys64/mingw64/include/stdio.h" 3
static __attribute__ ((__unused__)) __inline__ __attribute__((__cdecl__))
                                                      __attribute__ ((__nonnull__ (3)))
...
# 1188 "C:/msys64/mingw64/include/stdio.h" 2 3
# 1201 "C:/msys64/mingw64/include/stdio.h" 3
...
# 1264 "C:/msys64/mingw64/include/stdio.h" 3
  __attribute__ ((__dllimport__)) void __attribute__((__cdecl__)) _lock_file(FILE *_File);
  __attribute__ ((__dllimport__)) void __attribute__((__cdecl__)) _unlock_file(FILE *_File);
# 1286 "C:/msys64/mingw64/include/stdio.h" 3
...
# 1315 "C:/msys64/mingw64/include/stdio.h" 3
int __attribute__((__cdecl__)) __mingw_str_wide_utf8 (const wchar_t * const wptr, char **mbptr, size_t * buflen);
# 1329 "C:/msys64/mingw64/include/stdio.h" 3
...
# 1369 "C:/msys64/mingw64/include/stdio.h" 3
...
# 1388 "C:/msys64/mingw64/include/stdio.h" 2 3
# 3 "test.c" 2
# 1 "include/map.h" 1



# 1 "C:/msys64/mingw64/lib/gcc/x86_64-w64-mingw32/15.1.0/include/stdint.h" 1 3 4
# 9 "C:/msys64/mingw64/lib/gcc/x86_64-w64-mingw32/15.1.0/include/stdint.h" 3 4
#pragma GCC diagnostic push
...
# 1 "C:/msys64/mingw64/lib/gcc/x86_64-w64-mingw32/15.1.0/include/stddef.h" 1 3 4
...
# 2 "C:/msys64/mingw64/lib/gcc/x86_64-w64-mingw32/15.1.0/include/stddef.h" 2 3 4
# 441 "C:/msys64/mingw64/lib/gcc/x86_64-w64-mingw32/15.1.0/include/stddef.h" 3 4
typedef struct {
  long long __max_align_ll __attribute__((__aligned__(__alignof__(long long))));
  long double __max_align_ld __attribute__((__aligned__(__alignof__(long double))));
# 452 "C:/msys64/mingw64/lib/gcc/x86_64-w64-mingw32/15.1.0/include/stddef.h" 3 4
} max_align_t;
# 466 "C:/msys64/mingw64/lib/gcc/x86_64-w64-mingw32/15.1.0/include/stddef.h" 3 4
...
# 12 "C:/msys64/mingw64/lib/gcc/x86_64-w64-mingw32/15.1.0/include/stdint.h" 2 3 4
#pragma GCC diagnostic pop
# 5 "include/map.h" 2
...
typedef struct IntMap { hash_map *base; } IntMap; static inline IntMap IntMap_new(size_t capacity) { hash_map *base = new_hash_map(sizeof(const char*), sizeof(int), capacity); base->hash_fn = CSTR_HASH; base->cmp_fn = CSTR_CMP; base->kcpy_fn = CSTR_KCPY; base->kfree_fn = DEFAULT_KFREE; return (IntMap){base}; } static inline void IntMap_destroy(IntMap map) { destroy_hash_map(map.base); map.base = 
# 5 "test.c" 3 4
((void *)0)
# 5 "test.c"
;} static inline void IntMap_insert(IntMap map, const char* key, int value) { hash_map_insert(map.base, &key, &value); } static inline int IntMap_remove(IntMap map, const char* key) { int temp = *(int*)hash_map_get(map.base, &key); hash_map_remove(map.base, &key); return temp; } static inline int IntMap_get(IntMap map, const char* key) { int* ptr = hash_map_get(map.base, &key); return ptr ? *(int*)ptr : (int){0}; };

int main() {
    IntMap mymap = IntMap_new(5);
    IntMap_insert(mymap, "dude", 56);
    IntMap_insert(mymap, "diddyfoiddds", 999);
