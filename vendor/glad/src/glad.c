...
PFNGLGetMeshRenderBUFFERPARAMETERIVPROC glad_glGetMeshRenderbufferParameteriv = NULL;
...
static void load_GL_VERSION_3_0(GLADloadproc load) {
	...
	glad_glGetMeshRenderbufferParameteriv = (PFNGLGetMeshRenderBUFFERPARAMETERIVPROC)load("glGetMeshRenderbufferParameteriv");
